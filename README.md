...
**Technologies & Tools:**
- **Advanced AI Tooling Expertise:** Power user of GitHub Copilot, Claude Code, and Spec-Kit for enhanced development productivity and code quality
- **Context Engineering:** Applying context engineering principles to optimize product development and engineering processes, leveraging GraphRAG for team knowledge management and AI agent memory systems
- **Observability:** Datadog, Dynatrace, Prometheus, PagerDuty
- **Big Data:** Kafka, Debezium, Kstream, Druid, Spark, Hadoop, Superset
- **Cloud & Infrastructure:** VMWare, Hyper-V, Active Directory, Exchange
- **Development:** Ruby on Rails, Typescript, Python, Go, SQL
