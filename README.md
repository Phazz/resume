...
- **Real-Time Inventory System:** Led development of a real-time stock calculation system for one of Russia's top retailers — 99.99% SLO, 90% events processed under 1 min, 4K RPS
- **Scale:** Solution supporting 100+ stores and 35,000 employees on an event-driven architecture (Debezium, Kafka, Kstream, Druid, Spark)
- **Team Building:** Assembled and mentored a high-performing, reliability-focused engineering team from scratch
...
### International Product & Entrepreneurship
*May 2015 - June 2018 | Thailand*

**CPO** at all24 · **Co-Founder** at Pample Group · **Regional Director PMO & Web Dev** at aCommerce

- Led product strategy for a last-mile delivery platform (all24) serving the Thai consumer market
- Co-founded Pample, a data-driven influencer marketing platform — secured clients including Titan, Accor Hotel, Orami, and Lazada
- Built and managed a cross-functional team of 6 PMs and senior developers at aCommerce, overseeing 15+ e-commerce projects for international brands
- Forged strategic partnerships with Adyen, Magento, and Demandware

### **CIO / CTO** | BlueFox International
*June 2013 - May 2015 (2 years)*

- **Founding Team (Employee #2):** Built the entire technology stack from zero — CRM, Order Management, and Inventory Management SaaS on Ruby on Rails
- **Scale:** 300+ users across 7 countries, 200K+ orders processed. Built and led a team of 7

---

### Earlier Career

**IT Director → IT Manager** | Mazars *(2007 - 2013)*
Modernized infrastructure (VMWare, Exchange, SharePoint), virtualized 60 servers, achieved 15% cost reduction. Generated €200K+ in consulting revenue. Built IT from the ground up as first hire.

**Electrical Engineer** | Jacquelot *(2005 - 2007)*
Designed custom testing devices (hardware + software) for 3D electrical components.

---

## 🔮 Areas of Impact

- **Organizational Scaling** — Growing and structuring engineering orgs from 7 to 500+
- **Engineering Culture** — Governance frameworks, career paths, engineering excellence programs
- **Platform Strategy** — Global application platforms, build-vs-buy, vendor consolidation
- **AI-Driven Development** — Enterprise AI adoption, context engineering, developer productivity
- **Operational Excellence** — SLOs, observability at scale, reliability culture
